...
if __name__ == '__main__':
    ...
    train_img_xml_dir = "../coco_data/images/train2017"
    val_img_xml_dir = "../coco_data/images/train2017"
    save_json_train = "coco_data/annotations/instances_train2017.json"
    save_json_val = "coco_data/annotations/instances_val2017.json"
    img_format = ".jpg"
    ...
    print("convert done\nyou can use 'python tools/draw_coco_gt_box.py' to visualized the annotations")
